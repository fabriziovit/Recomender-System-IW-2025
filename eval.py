...
def compute_mae_rmse(test_matrix: pd.DataFrame, predictions_dict: dict) -> tuple:
...
# def evaluate_precision_recall(train_ratings_matrix, test_ratings_matrix, K_list, relevant_value, n_factors, precomputed_predictions: dict) -> dict:
...
#     with open(f"svd_accuracy_{relevant_value}_K{K}_nfactors{n_factors}.txt", "w") as f:
#         f.write("\n" + "=" * 70 + "\n")
